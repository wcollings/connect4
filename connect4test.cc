...
void print()
{
	cout <<board[0].r1 <<' ' <<board[1].r1 <<' ' <<board[2].r1 <<' ' <<board[3].r1 <<' ' <<board[4].r1 <<' ' <<board[5].r1 <<' ' <<board[6].r1 <<'\n'
		  <<board[0].r2 <<' ' <<board[1].r2 <<' ' <<board[2].r2 <<' ' <<board[3].r2 <<' ' <<board[4].r2 <<' ' <<board[5].r2 <<' ' <<board[6].r2 <<'\n'
		  <<board[0].r3 <<' ' <<board[1].r3 <<' ' <<board[2].r3 <<' ' <<board[3].r3 <<' ' <<board[4].r3 <<' ' <<board[5].r3 <<' ' <<board[6].r3 <<'\n'
		  <<board[0].r4 <<' ' <<board[1].r4 <<' ' <<board[2].r4 <<' ' <<board[3].r4 <<' ' <<board[4].r4 <<' ' <<board[5].r4 <<' ' <<board[6].r4 <<'\n'
		  <<board[0].r5 <<' ' <<board[1].r5 <<' ' <<board[2].r5 <<' ' <<board[3].r5 <<' ' <<board[4].r5 <<' ' <<board[5].r5 <<' ' <<board[6].r5 <<'\n'
		  <<board[0].r6 <<' ' <<board[1].r6 <<' ' <<board[2].r6 <<' ' <<board[3].r6 <<' ' <<board[4].r6 <<' ' <<board[5].r6 <<' ' <<board[6].r6 <<'\n';
}
...
bool checkBoard()
{
	return ( checkVertical() || checkHorizontal() || checkLeftDiag() || checkRightDiag());
}
